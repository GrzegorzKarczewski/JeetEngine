...
Model::Model(string const& path, bool gamma, bool flipUVs) 
...
unsigned int TextureFromFile(const char* path, const string& directory, bool gamma) {
    ...
    // added because sometimes when exported the model paths of textures were different in source mode file
    // so i use current path to check for textures
